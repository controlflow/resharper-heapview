...
class EnumHasFlags
{
  private bool Test01(Flags value, Flags flag) => value.HasFlag(flag); // yes, 2 boxes
  ...
  private bool Generic01<TEnum>(TEnum value, TEnum flag) where TEnum : Enum => value.HasFlag(flag); // possible, 2 boxes
  private bool Generic02<TEnum>(TEnum value, TEnum? flag) where TEnum : Enum => value.HasFlag(flag!); // possible, 2 boxes
  ...
  private bool Generic04<TEnum>(TEnum value, TEnum flag) where TEnum : struct, Enum => value.HasFlag(flag); // yes, 2 boxes
  ...
  private bool? Generic08<TEnum>(TEnum? value, TEnum flag) where TEnum : Enum => value?.HasFlag(flag); // yes, 2 boxes
